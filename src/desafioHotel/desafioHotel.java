 ...
 *  -Verificar os quartos disponiveis para alocação;
 *  -Realizar o check-in e o check-out
 *  
 *  O cadastro dos quartos devem ter Nome, Posição, Fumante?, Valor da Diária,
 *  qtd quarto e disponibilidade de pessoas por quarto.
 *  Já o cadastro dos clientes deverá constar: Nome, data de nascimento,
 *  e-mail, telefone, cidade, UF e Fumante?
 *  
 *  Escopo a ser abordado no trabalho:
 *  	-Uso de arrays e matrizes,
 *  	-Funções,
 *  	-Laços de decisão e repitação,
