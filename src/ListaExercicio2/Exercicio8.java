...
public class Exercicio8 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite quanto tempo o trabalhador está na empresa:");
		int temp = teclado.nextInt();
		
		if(idade >= 65 || temp >=30) {
			System.out.println("Este trabalhador já pode se aposentar!");
		} else if (idade >=60 && temp >=25) {
			System.out.println("Este trabalhador já pode se aposentar!");
		} else {
			System.out.println("Este trabalhador ainda não pode se aposentar!");
		}
