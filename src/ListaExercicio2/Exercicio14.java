/*
 * Crie um algoritmo que leia um valor e a partir disso faça: 1) se o valor dor 1 e 2,
...
public class Exercicio14 {
	...
	public static void main(String[] args) {
		...
		if(n1 == 1 || n1 == 2) {
			n1 = n1*n1*n1;
			System.out.println("Seu numero elevado ao cubo é "+n1);
		} else if(n1 % 3 == 0){
			double i = n1;
			double f = n1;
			while( i  > 1) {
			...
			System.out.println("O fatorial do numero "+n1+" é "+f);
