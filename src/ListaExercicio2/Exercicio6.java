/**
 * calcule a media dos alunos e indique se ele esta aprovado ou reprovado. permita que este aluno faça
...
public class Exercicio6 {
	...
	public static void main(String[] args) {
		...
		if(media > 7) {
			...
			if(n5>6) {
				System.out.println("Parabéns sua nota na recuperação foi "+n5+", você passou na Recuperação!");
			} else {
				System.out.println("Mesmo com a Recuperação você não passou");
			}
		}
