/**
 * Crie um algoritmo que leia um valor e a partir disso faça:1) se o valor for negativo,
...
public class Exercicio12 {
	...
	public static void main(String[] args) {
		...
		if (n1 < 0) {
			...
			int sub = (n1 - n2);
			System.out.println("A diferença entre "+n1+" e "+n2+" é de "+sub+" numeros.");
		} else {
			double div = (double) n1/ 5;
			System.out.println("Seu numero dividido por 5 é "+div);
		}
	}
