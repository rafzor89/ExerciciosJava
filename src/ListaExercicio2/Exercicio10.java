...
public class Exercicio10 {
	...
	public static void main(String[] args) {
		...
		System.out.println("a)média do salario dos Habitante é "+mediaSalario+" b)média de filhos é "+mediaFilho+" c)maior salario é de R$ "+mSalario+" e)Porcentagem de pessoas com salario menor que R$ 150,00: "+porce+"%");
